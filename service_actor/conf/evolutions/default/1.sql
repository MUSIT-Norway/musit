...
insert into MUSARK_ACTOR.ORGANIZATION (ID, FN, NICKNAME, TEL, WEB, LATITUDE, LONGITUDE) values (1, 'Kulturhistorisk museum - Universitetet i Oslo', 'KHM', '22 85 19 00', 'www.khm.uio.no', null, null);
insert INTO MUSARK_ACTOR.ORGANIZATION_ADDRESS (ORGANIZATION_ID, TYPE, STREET_ADDRESS, LOCALITY, POSTAL_CODE, COUNTRY_NAME) values (1, "WORK", "Fredriks gate 2", "OSLO", "0255", "NORWAY");
