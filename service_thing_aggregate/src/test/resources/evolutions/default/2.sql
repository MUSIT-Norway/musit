...
insert into MUSARK_STORAGE.LOCAL_OBJECT(object_id, latest_move_id, current_location_id) values(1, 23, 3,6);
insert into MUSARK_STORAGE.LOCAL_OBJECT(object_id, latest_move_id, current_location_id) values(2, 23, 3,6);
insert into MUSARK_STORAGE.LOCAL_OBJECT(object_id, latest_move_id, current_location_id) values(3, 23, 3,6);
