...
class StatusService extends Controller {
  ...
  @ApiOperation(value = "Status operation - Show simple fast status, made for monitoring.",
  ...
  @ApiOperation(value = "Extended status operation - Show an extended status to ease checking the internals.",
