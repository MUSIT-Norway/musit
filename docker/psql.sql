...
CREATE TABLE "MUSARK_STORAGE"."STORAGE_NODE" (
  "STORAGE_NODE_ID" DECIMAL(20) NOT NULL DEFAULT NEXTVAL ('"MUSARK_STORAGE"."STORAGE_NODE_SEQ"'),
  "STORAGE_NODE_NAME" VARCHAR(512),
  "AREA" DOUBLE PRECISION,
  "AREA_TO" DOUBLE PRECISION,
  "IS_STORAGE_UNIT" VARCHAR(1) DEFAULT '1',
  "IS_PART_OF" DECIMAL(20),
  ...
  "LATEST_MOVE_ID" DECIMAL(20),
  "LATEST_ENVREQ_ID" DECIMAL(20),
  "NODE_PATH" VARCHAR(4000),
  PRIMARY KEY ("STORAGE_NODE_ID")
);

CREATE TABLE "MUSARK_STORAGE"."ROOM" (
  "STORAGE_NODE_ID" DECIMAL(20) NOT NULL,
...
CREATE TABLE "MUSARK_STORAGE"."EVENT" (
  "ID" DECIMAL(20) NOT NULL DEFAULT NEXTVAL ('"MUSARK_STORAGE"."EVENT_SEQ"') ,
  ...
  "VALUE_LONG" DECIMAL(20), -- CUSTOM VALUE, EVENTS CAN CHOOSE TO STORE SOME EVENT-SPECIFIC VALUE HERE. NOTE: 20 IS PROBABLY WAAAAAAY TO MUCH.
  ...
  "PART_OF" DECIMAL(20), -- 1 TO 1 WITH A TOP-LEVEL EVENT
  PRIMARY KEY ("ID"),
...
CREATE TABLE "MUSARK_STORAGE"."EVENT_RELATION_EVENT" (
  "FROM_EVENT_ID" DECIMAL(20) NOT NULL,
  "RELATION_ID" INTEGER NOT NULL,
  "TO_EVENT_ID" DECIMAL(20) NOT NULL,
...
CREATE TABLE "MUSARK_STORAGE"."LOCAL_OBJECT" (
  ...
  "LATEST_MOVE_ID" DECIMAL(20) NOT NULL,
  "CURRENT_LOCATION_ID" DECIMAL(20) NOT NULL,
...
CREATE TABLE "MUSARK_STORAGE"."URI_LINKS" (
  "ID" DECIMAL(20) NOT NULL DEFAULT NEXTVAL ('"MUSARK_STORAGE"."URI_LINKS_SEQ"') ,
  "LOCAL_TABLE_ID" DECIMAL(20) NOT NULL,
