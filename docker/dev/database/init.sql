...
CREATE TABLE "MUSARK_STORAGE"."ROOM" (
  ...
  "PERIMETER_SECURITY" BOOLEAN, -- DEFAULT 0 NOT NULL,
  "THEFT_PROTECTION" BOOLEAN, -- DEFAULT 1 NOT NULL,
  "FIRE_PROTECTION" BOOLEAN, -- DEFAULT 0 NOT NULL,
  "WATER_DAMAGE_ASSESSMENT" BOOLEAN, -- DEFAULT 0 NOT NULL,
  "ROUTINES_AND_CONTINGENCY_PLAN" BOOLEAN, -- DEFAULT 0 NOT NULL,
  "RELATIVE_HUMIDITY" BOOLEAN, -- DEFAULT 0 NOT NULL,
  "TEMPERATURE_ASSESSMENT" BOOLEAN, -- DEFAULT 0 NOT NULL,
  "LIGHTING_CONDITION" BOOLEAN, -- DEFAULT 0 NOT NULL,
  "PREVENTIVE_CONSERVATION" BOOLEAN, -- DEFAULT 0 NOT NULL,
  PRIMARY KEY ("STORAGE_NODE_ID"),
...
CREATE SEQUENCE "MUSIT_MAPPING"."VIEW_MUSITTHING_SEQ";

CREATE TABLE "MUSIT_MAPPING"."VIEW_MUSITTHING" (
  "ID" BIGINT NOT NULL DEFAULT NEXTVAL ('"MUSIT_MAPPING"."VIEW_MUSITTHING_SEQ"'),
  "DISPLAYID" VARCHAR NOT NULL,
  "DISPLAYNAME" VARCHAR
);

insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(1, 'MusK58/1', 'Rar dings');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(2, 'MusK58/2', 'Mansjettknapp');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(3, 'MusK58/3', 'Spenne');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(4, 'MusK58/4', 'Briller');

insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(1, 9999, 4);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(2, 9999, 4);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(3, 9999, 4);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(4, 9999, 4);

insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(5, 'MusN36/1', 'Husflue');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(6, 'MusN45', 'Dyngebille');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(7, 'MusN36/2', 'Spyflue');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(8, 'MusN37', 'Bendelorm');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(9, 'MusN28', 'Tusenben');

insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(5, 9999, 5);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(6, 9999, 5);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(7, 9999, 5);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(8, 9999, 5);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(9, 9999, 5);

insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(10, 'MusK400', 'Brynje');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(11, 'MusN337', 'Sommerfulgvinge');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(12, 'MusN77', 'Lavastein');
insert into "MUSIT_MAPPING"."VIEW_MUSITTHING"("ID", "DISPLAYID", "DISPLAYNAME") values(13, 'MusK43', 'Krakk');

insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(10, 9999, 6);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(11, 9999, 6);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(12, 9999, 6);
insert into "MUSARK_STORAGE"."LOCAL_OBJECT"("OBJECT_ID", "LATEST_MOVE_ID", "CURRENT_LOCATION_ID") values(13, 9999, 6);
