...
class ActorByIdOrNameSpec extends WordSpec with MustMatchers with Inside {
  ...
  "ActorName" when {
    ...
    "apply" should {
      "parse actor value to id" in {
        ...
        val res = ActorByIdOrName(expectedId.toString)
      ...
      "parse actor value to name" in {
        ...
        val res = ActorByIdOrName(testName.toString)
