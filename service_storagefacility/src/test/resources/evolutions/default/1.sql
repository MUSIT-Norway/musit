...
VALUES
  ('root-node', NULL, NULL, '1', NULL, NULL, NULL, FALSE, 'Root', NULL, NULL,
   ',1,', 2, 123, '2016-01-01 00:00:00');

INSERT INTO MUSARK_STORAGE.STORAGE_NODE (STORAGE_NODE_NAME, AREA, AREA_TO, IS_STORAGE_UNIT, IS_PART_OF, HEIGHT, HEIGHT_TO, IS_DELETED, STORAGE_TYPE, GROUP_READ, GROUP_WRITE, NODE_PATH, MUSEUM_ID,
                                         UPDATED_BY, UPDATED_DATE)
VALUES
  ('Utviklingsmuseet', NULL, NULL, '1', 1, NULL, NULL, FALSE, 'Organisation',
                       NULL, NULL, ',1,2,', 2, 123, '2016-01-01 00:00:00');

INSERT INTO MUSARK_STORAGE.STORAGE_NODE (STORAGE_NODE_NAME, AREA, AREA_TO, IS_STORAGE_UNIT, IS_PART_OF, HEIGHT, HEIGHT_TO, IS_DELETED, STORAGE_TYPE, GROUP_READ, GROUP_WRITE, NODE_PATH, MUSEUM_ID,
                                         UPDATED_BY, UPDATED_DATE)
VALUES
  ('Forskningens hus', NULL, NULL, '1', 2, NULL, NULL, FALSE, 'Building', NULL,
                       NULL, ',1,2,3,', 2, 123, '2016-01-01 00:00:00');

INSERT INTO MUSARK_STORAGE.STORAGE_NODE (STORAGE_NODE_NAME, AREA, AREA_TO, IS_STORAGE_UNIT, IS_PART_OF, HEIGHT, HEIGHT_TO, IS_DELETED, STORAGE_TYPE, GROUP_READ, GROUP_WRITE, NODE_PATH, MUSEUM_ID,
                                         UPDATED_BY, UPDATED_DATE)
VALUES
  ('Kulturværelset', NULL, NULL, '1', 3, NULL, NULL, FALSE, 'Room', NULL, NULL,
   ',1,2,3,4,', 2, 123, '2016-01-01 00:00:00');

INSERT INTO MUSARK_STORAGE.STORAGE_NODE (STORAGE_NODE_NAME, AREA, AREA_TO, IS_STORAGE_UNIT, IS_PART_OF, HEIGHT, HEIGHT_TO, IS_DELETED, STORAGE_TYPE, GROUP_READ, GROUP_WRITE, NODE_PATH, MUSEUM_ID,
                                         UPDATED_BY, UPDATED_DATE)
VALUES
  ('Naturværelset', NULL, NULL, '1', 3, NULL, NULL, FALSE, 'Room', NULL, NULL,
   ',1,2,3,5,', 2, 123, '2016-01-01 00:00:00');

INSERT INTO MUSARK_STORAGE.STORAGE_NODE (STORAGE_NODE_NAME, AREA, AREA_TO, IS_STORAGE_UNIT, IS_PART_OF, HEIGHT, HEIGHT_TO, IS_DELETED, STORAGE_TYPE, GROUP_READ, GROUP_WRITE, NODE_PATH, MUSEUM_ID,
                                         UPDATED_BY, UPDATED_DATE)
VALUES
  ('Forskningsværelset', NULL, NULL, '1', 3, NULL, NULL, FALSE, 'Room', NULL,
                         NULL, ',1,2,3,6,', 2, 123, '2016-01-01 00:00:00');
...
INSERT INTO MUSARK_STORAGE.ROOM
VALUES (6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
