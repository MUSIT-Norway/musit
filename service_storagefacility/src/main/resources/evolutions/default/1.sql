...
CREATE TABLE MUSARK_STORAGE.STORAGE_NODE (
  storage_node_id   NUMBER(20) GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE MUSARK_STORAGE.ROLE (
  role_id INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE MUSARK_STORAGE.EVENT_TYPE (
  event_type_id INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE MUSARK_STORAGE.EVENT (
  event_id        NUMBER(20) GENERATED BY DEFAULT ON NULL AS IDENTITY,
