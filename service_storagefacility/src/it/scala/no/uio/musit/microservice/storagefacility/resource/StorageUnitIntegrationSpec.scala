  ...
  "Running the storage facility service" when {
    ...
    "interacting with the StorageUnitResource endpoints" should {
      ...
      "successfully create a few root nodes" in {
        ...
        val mid = 2
        generateAndAddRootNode(mid, 2).size mustBe 2
        val mid1 = 3
        generateAndAddRootNode(mid1, 2).size mustBe 2

      }

      "successfully create an organisation node" in {
        val mid = 2
        val json = organisationJson("My Org1", Some(StorageNodeId(5)))
        ...
        val organisation = verifyNode[Organisation](
          response, OrganisationType, "My Org1", newOrg.id.get, Some(5)
        )
        organisation mustBe a[Organisation]
      ...
      "successfully get an organisation" in {
        ...
        val organisation = verifyNode[Organisation](
          response, OrganisationType, "My Org1", 5, Some(5)
        )
