...
CREATE TABLE MUSARK_STORAGE.EVENT (
  ...
  note            VARCHAR2(500),
  event_date      TIMESTAMP WITH TIMEZONE NOT NULL, -- When the event happened. Should be nullable.
  registered_by   VARCHAR2(36) NOT NULL,
  registered_date TIMESTAMP WITH TIMEZONE NOT NULL, -- When the event was received by the system
