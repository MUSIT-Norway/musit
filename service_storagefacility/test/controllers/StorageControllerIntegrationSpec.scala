  ...
  "Running the storage facility service" when {
    ...
    "interacting with the StorageController endpoints" should {
      ...
      "successfully update a storage unit" in {
        ...
        val updRes = wsUrl(StorageNodeUrl(mid, su.id.value))
          .withHeaders(adminToken.asHeader)
          .put(updatedJson)
          .futureValue
      ...
      "successfully update a room" in {
        ...
        val updRes = wsUrl(StorageNodeUrl(mid, room.id.value))
          .withHeaders(adminToken.asHeader)
          .put(updatedJson)
          .futureValue
        updRes.status mustBe OK
      ...
      "successfully update a building with environment requirements" in {
        ...
        val updRes = wsUrl(StorageNodeUrl(mid, building.id.value))
          .withHeaders(adminToken.asHeader)
          .put(updatedJson)
          .futureValue
        updRes.status mustBe OK
      ...
      "successfully update an organisation" in {
        ...
        val updRes = wsUrl(StorageNodeUrl(mid, organisation.id.value))
          .withHeaders(adminToken.asHeader)
          .put(updatedJson)
          .futureValue
        updRes.status mustBe OK
      ...
      "successfully delete a storage node" in {
        ...
        val rmRes = wsUrl(StorageNodeUrl(mid, created.id.value))
          .withHeaders(adminToken.asHeader)
          .delete()
          .futureValue
        rmRes.status mustBe OK

        val notFound = wsUrl(StorageNodeUrl(mid, created.id.value))
          .withHeaders(readToken.asHeader)
          .get()
          .futureValue
      ...
      "successfully move some nodes and fail for others when museumId is invalid" in {
        ...
        val o3 = wsUrl(StorageNodesUrl(anotherMid))
          ...
          .post(organisationJson("Hanky", Some(StorageNodeDatabaseId(21))))
          .futureValue
        ...
        val b3 = wsUrl(StorageNodesUrl(anotherMid))
          .withHeaders(anotherToken.asHeader)
          .post(buildingJson("Panky", StorageNodeDatabaseId(o3Id)))
          .futureValue
        ...
        val n3 = verifyNode[StorageUnit](
          ...
          "Move me3",
          id3,
          Some(StorageNodeDatabaseId(b3Id))
        )
