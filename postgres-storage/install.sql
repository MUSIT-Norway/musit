...
CREATE TABLE "MUSARK_STORAGE"."ROOM"(
  ...
  "SIKRING_SKALLSIKRING"        boolean DEFAULT false,
  "SIKRING_TYVERISIKRING"       boolean DEFAULT false,
  "SIKRING_BRANNSIKRING"        boolean DEFAULT false,
  "SIKRING_VANNSKADERISIKO"     boolean DEFAULT false,
  "SIKRING_RUTINE_OG_BEREDSKAP" boolean DEFAULT false,
  "BEVAR_LUFTFUKT_OG_TEMP"      boolean DEFAULT false,
  "BEVAR_LYSFORHOLD"            boolean DEFAULT false,
  "BEVAR_PREVANT_KONS"          boolean DEFAULT false,
  PRIMARY KEY ("STORAGE_UNIT_ID"),
