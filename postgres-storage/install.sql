...
CREATE TABLE "MUSARK_STORAGE"."ROOM"(
  ...
  "PERIMETER_SECURITY"        boolean DEFAULT false,
  "THEFT_PROTECTION"       boolean DEFAULT false,
  "FIRE_PROTECTION"        boolean DEFAULT false,
  "WATER_DAMAGE_ASSESSMENT"     boolean DEFAULT false,
  "ROUTINES_AND_CONTINGENCY_PLAN" boolean DEFAULT false,
  "RELATIVE_HUMIDITY"      boolean DEFAULT false,
  "TEMPERATURE_ASSESSMENT"      boolean DEFAULT false,
  "LIGHTING_CONDITION"            boolean DEFAULT false,
  "PREVENTIVE_CONSERVATION"          boolean DEFAULT false,
  PRIMARY KEY ("STORAGE_UNIT_ID"),
